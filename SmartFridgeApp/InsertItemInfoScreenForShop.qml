...
Page {
    ...
    function insertItem(){
        if(amountInput.value > 0 && expiryInput.text != ""){
            let x = 0
            x = itemtool.getDeliverItemsCount(itemName,orderID)
            if(amountInput.value <= x){
                itemtool.updateDeliverItems(amountInput.value, itemName, orderID)
                itemtool.insertItemDelivery(orderID, itemName, amountInput.value, expiryInput.text)
                ...
                itemnameText6.visible = false
                itemnameText7.visible = true
                itemnameText7.text = qsTr("Needed: " + itemtool.getDeliverItemsCount(itemName,orderID))
                ...
                message.text = "Cannot insert more than the required amount"
            }
        }
    }
    ...
    Rectangle {
        ...
        Button {
            ...
            onClicked: {
                ...
                thestackView.pop()
                theOrderDeliverModel.updateOrderDeliverModel()
                itemnameText6.visible = true
                itemnameText7.visible = false
        ...
        Text {
            ...
            y: 382
            visible: true
            text: qsTr("Needed: " + itemtool.getDeliverItemsCount(itemName,orderID))
            font.pixelSize: 25
            font.bold: false
        }
